...
Create-Thumbnail-Sample-Style `
    -bgImagePath "static/images/clinics/clinic-tic.jpg"     -outputPath "static/images/blog/column-03-tic-bundang.jpg"     -line1Text "눈 깜빡임·음음 소리"     -line2Text "참지 못하는 헛기침"     -line3Text "판교 틱장애"
...
Create-Thumbnail-Sample-Style `
    -bgImagePath "static/images/clinics/clinic-sleep.jpg"     -outputPath "static/images/blog/column-04-sleep-bundang.jpg"     -line1Text "밤마다 뒤척이고"     -line2Text "새벽에 자꾸 깨는"     -line3Text "수지 불면증"

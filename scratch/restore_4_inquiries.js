...
const targetFunction = `// 4 Permanent Base Inquiries (Always present on all devices)
...
mainJs = mainJs.replace(/function getStoredInquiries\(\) \{[\s\S]*?return merged;\s*\}/, targetFunction);

fs.writeFileSync('assets/js/main.js', mainJs, 'utf-8');
console.log('Successfully restored the 4 authentic consultation Q&As into PERMANENT_BASE_INQUIRIES!');

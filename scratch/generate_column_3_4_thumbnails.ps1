...
function Create-Diagram-Thumbnail {
    param (
        ...
        [string]$rightBoxText,
        [string]$rightBoxSub,
        [string]$themeColorLeft = "#EF4444",
        [string]$themeColorRight = "#0EA5E9"
    )
    ...
    $pillRect = New-Object System.Drawing.Rectangle(60, 60, 240, 40)
    ...
    $g.DrawString($mainTitle, $titleFont, $whiteBrush, 60, 115)
    $g.DrawString($subTitle, $subFont, $lightGrayBrush, 60, 175)
    ...
    $containerRect = New-Object System.Drawing.Rectangle(50, 225, 700, 425)
...
Create-Diagram-Thumbnail `
    ...
    -parentBoxSub "시상하부 & 멜라토닌 분비 조절 시스템" `

...
fs.writeFileSync('scratch/render_sample_style_thumbs.ps1', '\ufeff' + psScript, 'utf-8');
console.log('Saved scratch/render_sample_style_thumbs.ps1 with UTF-8 BOM');
try {
  const output = execSync('powershell.exe -ExecutionPolicy Bypass -File scratch/render_sample_style_thumbs.ps1', { encoding: 'utf-8' });
  console.log(output);
} catch (e) {

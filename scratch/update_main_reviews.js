...
// Format clean full titles and summaries for the real reviews
...
// Read main.js and replace NAVER_REVIEWS_DATA
...
if (sIdx !== -1 && eIdx !== -1) {
  const newNaverBlock = `const NAVER_REVIEWS_DATA = ${JSON.stringify(realReviewsData, null, 2)};\n\n`;
  ...
  console.log('Successfully updated assets/js/main.js with REAL Naver visitor reviews!');
} else {
  console.error('Could not find NAVER_REVIEWS_DATA markers in assets/js/main.js');
}

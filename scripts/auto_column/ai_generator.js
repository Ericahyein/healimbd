...
7. [치료법 및 시술 임의 명칭 생성 금지 (GLOBAL RULE)]
   - 승인된 치료 항목: '개인 체질 맞춤 한약 처방', '침구 치료', '약침 치료', '추나요법', '이완 요법 및 생활 관리 상담' 등 실제 승인된 기본 한의 치료 항목만 사용하십시오.
   - '안심 한약', '두뇌 회복탕' 등 임의의 고유 처방 명칭이나 '두경부 중심의 혈자리', '특정 혈자리 자극' 등 구체적인 경혈/신체 부위 중심 시술명을 임의 생성하여 서술하는 것을 엄격히 금지합니다.

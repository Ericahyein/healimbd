/**
 * Seed 4 Authentic Doctor Consultation Inquiries to Firestore
 * Usage: node scripts/seed_firestore_inquiries.js
 */

const AUTHENTIC_4_INITIAL_INQUIRIES = [
  {
    id: "inq_01_autonomic",
    category: "autonomic",
    nickname: "분당주민",
    ...
    answeredAt: new Date("2026-08-31T10:30:00Z")
  },
  {
    id: "inq_02_adhd",
    category: "adhd",
    ...
    createdAt: new Date("2026-08-31T08:30:00Z"),
    answeredAt: new Date("2026-08-31T10:00:00Z")
  },
  {
    id: "inq_03_sleep",
    category: "sleep",
    ...
    answeredAt: new Date("2026-08-31T09:30:00Z")
  },
  {
    id: "inq_04_tic",
    category: "tic",
    ...
    createdAt: new Date("2026-08-31T07:30:00Z"),
    answeredAt: new Date("2026-08-31T09:00:00Z")
  }
];

console.log("Ready to seed", AUTHENTIC_4_INITIAL_INQUIRIES.length, "inquiries to Firestore.");
module.exports = { AUTHENTIC_4_INITIAL_INQUIRIES };
